...
class LRFELMAE(object):
    def __init__(self, C, n_estimators):
        self.C = C
    ...
    def _build(self):
        ...
        # layer1
        subnet1 = OrderedDict()
        subnet1['7x7'] = ELMAELayer(C=self.C, n_hidden=12, filter_size=7, stride=1)
        subnet1['5x5'] = ELMAELayer(C=self.C, n_hidden=12, filter_size=5, stride=1)
        subnet1['3x3'] = ELMAELayer(C=self.C, n_hidden=12, filter_size=3, stride=1)
        net['layer1'] = MergeLayer(subnet1)
        net['bn1'] = BNLayer()
        net['pool1'] = FMPLayer(pool_ratio=1.732)
        # layer2
        subnet2 = OrderedDict()
        subnet2['7x7'] = ELMAELayer(C=self.C, n_hidden=12, filter_size=7, stride=1)
        subnet2['5x5'] = ELMAELayer(C=self.C, n_hidden=12, filter_size=5, stride=1)
        subnet2['3x3'] = ELMAELayer(C=self.C, n_hidden=12, filter_size=3, stride=1)
        net['layer2'] = MergeLayer(subnet2)
        net['bn2'] = BNLayer()
        net['pool2'] = FMPLayer(pool_ratio=1.732)
        # layer3
        subnet3 = OrderedDict()
        subnet3['7x7'] = ELMAELayer(C=self.C, n_hidden=12, filter_size=7, stride=1)
        subnet3['5x5'] = ELMAELayer(C=self.C, n_hidden=12, filter_size=5, stride=1)
        subnet3['3x3'] = ELMAELayer(C=self.C, n_hidden=12, filter_size=3, stride=1)
        net['layer3'] = MergeLayer(subnet3)
        net['bn3'] = BNLayer()
        net['pool3'] = FMPLayer(pool_ratio=1.732)
        return net
    ...
    def train(self, inputX, inputy):
        ...
        self.classifier = Classifier(self.C, 5)
