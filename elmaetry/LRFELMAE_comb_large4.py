...
class ELMAELayer(Layer):
    def __init__(self, split_list, params):
    ...
    def get_train_output_for(self, inputX):
        ...
        for num in xrange(len(self.split_list)):
            ...
            for x in splitX_list:
                elmaepool = ELMAEPoolLayer(**self.params[num])
    ...
    def _build(self):
        ...
        params1.append(
            {'C': self.C, 'n_hidden': 180, 'filter_size': 11, 'pad': 0, 'stride': 1, 'pad_': None, 'stride_': 4,
             'noise_level': 0.2, 'pool_type': 'fp', 'pool_size': 1.414, 'mode': 'max', 'cccp_out': 60})
        params1.append(
            {'C': self.C, 'n_hidden': 90, 'filter_size': 6, 'pad': 0, 'stride': 1, 'pad_': None, 'stride_': 2,
             'noise_level': 0.2, 'pool_type': 'fp', 'pool_size': 1.414, 'mode': 'max', 'cccp_out': 30})
        params1.append(
            {'C': self.C, 'n_hidden': 60, 'filter_size': 5, 'pad': 0, 'stride': 1, 'pad_': None, 'stride_': 1,
             'noise_level': 0.2, 'pool_type': 'fp', 'pool_size': 1.414, 'mode': 'max', 'cccp_out': 20})
        net['layer1'] = ELMAELayer(split_list=[1, 2, 3], params=params1)
        # net['bn1'] = BNLayer()
        ...
        params2 = []
        params2.append(
            {'C': self.C, 'n_hidden': 120, 'filter_size': 7, 'pad': 0, 'stride': 1, 'pad_': None, 'stride_': 2,
             'noise_level': 0.2, 'pool_type': 'pool', 'pool_size': (2, 2), 'mode': 'max', 'cccp_out': 60})
        params2.append(
            {'C': self.C, 'n_hidden': 60, 'filter_size': 3, 'pad': 0, 'stride': 1, 'pad_': None, 'stride_': 1,
             'noise_level': 0.2, 'pool_type': 'pool', 'pool_size': (2, 2), 'mode': 'max', 'cccp_out': 30})
        net['layer2'] = ELMAELayer(split_list=[1, 2], params=params2)
        # net['bn3'] = BNLayer()
