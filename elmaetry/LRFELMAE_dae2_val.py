...
class LRFELMAE(object):
    ...
    def _build(self):
        ...
        net['fmp1'] = FPLayer(pool_ratio=1.414, mode='avg')
        # layer2
        ...
        net['fmp2'] = FPLayer(pool_ratio=1.414, mode='avg')
        # layer3
        ...
        net['fmp3'] = FPLayer(pool_ratio=1.414, mode='avg')
        # layer4
